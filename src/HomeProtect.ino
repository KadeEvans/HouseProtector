 ...
 * Description: Basic Tutorial project for the Particle Environmental Sensor Kit
...
void createEventPayload(int temp, int humidity, int pressure, String airQuality)
{
  ...
  Particle.publish("sheetTest1", jw.getBuffer(), PRIVATE);
  Log.info("published ; %s", jw.getBuffer());
}
